...
func getGreenColor() -> UIColor {
    return UIColor(red: 10, green: 255, blue: 10, alpha: 255)
}
...
class ShapeManager {
  ...
  func spawnSphereShape(position: SCNVector3) {
        let shapeType: ShapeType = ShapeType.getSphere()
        placeShape(position: position, type: shapeType)
  }
